...
const Work = () => {
  ...
  const fallbackProjects = [
    { category: "Fashion", title: "The Runway Edit", description: "Where style meets story." },
    { category: "Fashion", title: "Threads of Tomorrow", description: "Minimal design, maximal impact." },
    { category: "Jewellery", title: "Heritage in Motion", description: "Cinematic jewellery story." },
    { category: "Jewellery", title: "Gilded Whispers", description: "Quiet luxury in detail." },
    { category: "Real Estate", title: "The Skyline Chapter", description: "Concrete turned into conversation." },
    { category: "Real Estate", title: "House of Horizons", description: "Architecture meets aspiration." },
  ];
        ...
        {isLoading ? (
          ...
          <div ref={gridRef} className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-24">
            {displayProjects.map((project, index) => {
              ...
              const projectId = isDbProject ? (project as WorkPost).id : `fallback-${index}`;
              ...
              return (
                ...
                >
                  <div className="bg-card border border-border aspect-[4/5] mb-4 overflow-hidden relative">
                    {isDbProject ? (
                      <VideoPlayer
                        videoUrl={(project as WorkPost).video_url}
                        videoFilePath={(project as WorkPost).video_file_path}
                        thumbnailUrl={(project as WorkPost).thumbnail_url}
                        title={project.title}
